-- ============================================================
--  AngelQuant Database Setup (run once as MySQL root)
--  Windows: mysql -u root -p < scripts\setup_db.sql
--  Linux:   mysql -u root -p < scripts/setup_db.sql
-- ============================================================

CREATE DATABASE IF NOT EXISTS angelquant_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE USER IF NOT EXISTS 'aquser'@'localhost' IDENTIFIED BY 'aqpass123';
CREATE USER IF NOT EXISTS 'aquser'@'%'         IDENTIFIED BY 'aqpass123';

GRANT ALL PRIVILEGES ON angelquant_db.* TO 'aquser'@'localhost';
GRANT ALL PRIVILEGES ON angelquant_db.* TO 'aquser'@'%';
FLUSH PRIVILEGES;
